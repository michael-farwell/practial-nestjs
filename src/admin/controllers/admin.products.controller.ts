import {
  Body, Controller, Get, Param, Post, Redirect, Render, Req, Res, UploadedFile, UseInterceptors,
} from "@nestjs/common";
...
export class AdminProductsController {
  ...
  @Post("/:id/update")
  @UseInterceptors(FileInterceptor("image", { dest: "./public/uploads" }))
  async update (@Body() body, @UploadedFile() file: Express.Multer.File,
    @Param("id") id: string, @Req() request, @Res() response) {
